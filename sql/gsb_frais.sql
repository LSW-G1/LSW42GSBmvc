...
CREATE TABLE `Absence` (
  ...
  `codeMotif` varchar(4) NOT NULL,
  `mois` int(11) NOT NULL,
  `nombre` int(11) NOT NULL,
  PRIMARY KEY (`mois`,`idVisiteur`,`codeMotif`),
  KEY `idVisiteur` (`idVisiteur`),
  KEY `codeMotif` (`codeMotif`),
  CONSTRAINT `Absence_ibfk_1` FOREIGN KEY (`idVisiteur`) REFERENCES `Visiteur` (`id`),
  CONSTRAINT `Absence_ibfk_2` FOREIGN KEY (`codeMotif`) REFERENCES `Motif` (`code`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

INSERT INTO `Absence` (`idVisiteur`, `codeMotif`, `mois`, `nombre`) VALUES
  ('dev',	'ABS1',	1,	5),
  ('dev',	'ABS2',	1,	9);
...
INSERT INTO `Motif` (`code`, `libelle`) VALUES
  ('ABS1',	'Rendez-vous médical'),
  ('ABS2',	'Rendez-vous avec un client'),
  ('ABS3',	'Absence injustifiée'),
  ('ABS4',	'Urgence');
