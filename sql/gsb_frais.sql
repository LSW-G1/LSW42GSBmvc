...
INSERT INTO `Client` (`idClient`, `nom`, `prenom`, `lieu`, `idTypeClient`) VALUES
(1,	'SERRE',	'Luc',	'Saint-Étienne',	1),
(2,	'ASSELINEAU',	'Éric',	'Paris',	2),
(4,	'BEAUVAIS',	'Ernest',	'Lyon',	3);
...
INSERT INTO `TypeClient` (`idTypeClient`, `libelle`) VALUES
(1,	'Médecin'),
(2,	'Vétérinaire'),
(3,	'Dentiste');
